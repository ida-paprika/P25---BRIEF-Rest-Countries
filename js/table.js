...
async function render() {
    let response = await fetch('https://restcountries.com/v3.1/region/europe?fields=name,capital,area,population,cca2');
    ...
    COUNTRIES.forEach(country => {
        rows += `<tr>
                    ...
                    <td><a href="geolocation.html?cca2=${country.cca2}">${country.capital[country.capital.length-1]}</a></td>
                </tr>`;
    });
